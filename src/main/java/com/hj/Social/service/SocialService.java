	...
	public String getAccessToken(String code, String gate) {
		...
		try {
			...
			if ("naver".equals(gate)) {
				redirectURI = URLEncoder.encode("https://www.hjsocial.com/social/login?type=naver", "UTF-8");
	            ...
	            redirectURI = URLEncoder.encode("https://www.hjsocial.com/social/login?type=kakao", "UTF-8");
	            ...
	            redirectURI = URLEncoder.encode("https://www.hjsocial.com/social/login?type=google", "UTF-8");
